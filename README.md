...
2. [Variáveis e Operações aritméticas](https://github.com/infoweb-logica/04-notas_de_aula-02-python) - [lista de exercício](https://github.com/infoweb-logica/04-notas_de_aula-02-python/blob/main/lista.md)
3. [Funções matemáticas](https://github.com/infoweb-logica/05-notas_de_aula-03-python) - [lista de exercício](https://github.com/infoweb-logica/05-notas_de_aula-03-python/blob/main/lista.md)
4. [Operadores lógicos e relacionais](https://github.com/infoweb-logica/06-notas_de_aula-04-python) - [lista de exercício](https://github.com/infoweb-logica/06-notas_de_aula-04-python/blob/main/lista.md)
5. [Estruturas de seleção](https://github.com/infoweb-logica/07-notas_de_aula-05-python) - [lista de exercício](https://github.com/infoweb-logica/07-notas_de_aula-05-python/blob/main/lista.md)
