...
## Notas de aula
1. :paperclip: [Alo mundo](https://github.com/infoweb-logica/03-notas_de_aula-01-python) 
2. :paperclip: [Variáveis e Operações aritméticas](https://github.com/infoweb-logica/04-notas_de_aula-02-python) - :pencil2: [lista de exercício](https://github.com/infoweb-logica/04-notas_de_aula-02-python/blob/main/lista.md)
3. :paperclip: [Funções matemáticas](https://github.com/infoweb-logica/05-notas_de_aula-03-python) - :pencil2: [lista de exercício](https://github.com/infoweb-logica/05-notas_de_aula-03-python/blob/main/lista.md)
4. :paperclip: [Operadores lógicos e relacionais](https://github.com/infoweb-logica/06-notas_de_aula-04-python) - :pencil2: [lista de exercício](https://github.com/infoweb-logica/06-notas_de_aula-04-python/blob/main/lista.md)
5. :paperclip: [Estruturas de seleção](https://github.com/infoweb-logica/07-notas_de_aula-05-python) - :pencil2: [lista de exercício](https://github.com/infoweb-logica/07-notas_de_aula-05-python/blob/main/lista.md)
6. :paperclip: [Depuração](https://github.com/infoweb-logica/08-notas_de_aula-06-python)
...
11. :paperclip: [Listas](https://github.com/infoweb-logica/13-notas_de_aula-11-python) - :pencil2: [lista de exercício](https://github.com/infoweb-logica/13-notas_de_aula-11-python/blob/main/lista.md)
