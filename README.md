...
2. [Variáveis e Operações aritméticas](https://github.com/infoweb-logica/04-notas_de_aula-02-python) - :pencil2: [lista de exercício](https://github.com/infoweb-logica/04-notas_de_aula-02-python/blob/main/lista.md)
3. [Funções matemáticas](https://github.com/infoweb-logica/05-notas_de_aula-03-python) - :pencil2: [lista de exercício](https://github.com/infoweb-logica/05-notas_de_aula-03-python/blob/main/lista.md)
4. [Operadores lógicos e relacionais](https://github.com/infoweb-logica/06-notas_de_aula-04-python) - :pencil2: [lista de exercício](https://github.com/infoweb-logica/06-notas_de_aula-04-python/blob/main/lista.md)
5. [Estruturas de seleção](https://github.com/infoweb-logica/07-notas_de_aula-05-python) - :pencil2: [lista de exercício](https://github.com/infoweb-logica/07-notas_de_aula-05-python/blob/main/lista.md)
6. [Depuração](https://github.com/infoweb-logica/08-notas_de_aula-06-python)
7. [Estrutura de repetição - while - contanto](https://github.com/infoweb-logica/09-notas_de_aula-07-python) - :pencil2: [lista de exercício](https://github.com/infoweb-logica/09-notas_de_aula-07-python/blob/main/lista.md)
8. [Estrutura de repetição - while - acumulando](https://github.com/infoweb-logica/10-notas_de_aula-08-python) - :pencil2: [lista de exercício](https://github.com/infoweb-logica/10-notas_de_aula-08-python/blob/main/lista.md)
9. [Estrutura de repetição - for](https://github.com/infoweb-logica/11-notas_de_aula-09-python) - :pencil2: [lista de exercício](https://github.com/infoweb-logica/11-notas_de_aula-09-python/blob/main/lista.md)
